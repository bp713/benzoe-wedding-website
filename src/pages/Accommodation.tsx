export default function Accommodation() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-10">
      ...
      <p className="mb-4 text-base sm:text-lg">
        Of course! There will be an option on the RSVP to let us know whether
        you'd like to stay for one or two nights, or whether you'd prefer to
        sort your own accommodation.
      </p>
      <h2 className="mb-6 text-2xl font-semibold">
      ...
      <p className="mb-4 text-base sm:text-lg">
        ...
        minutes from Hull if you would prefer to stay offsite (or, of course,
        you may just want to sleep in your own beds!) Nearby hotels include:
      </p>
      <ul className="mb-4 list-inside list-disc text-base sm:text-lg">
        <li>Premier Inn - Beverley Town Centre Hotel (18 minute drive)</li>
        <li>Premier Inn - Hull City Centre (24 minute drive)</li>
      </ul>
      <p className="mb-6 text-base sm:text-lg">
        The only thing to bear in mind is that there is limited signal at the
        venue, so taxis will need to be booked in advance.
      </p>
    </div>
  );
}
